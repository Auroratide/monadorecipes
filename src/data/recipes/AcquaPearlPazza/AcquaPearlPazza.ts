...
const recipe: Recipe = {
	...
	description: "Fish and seafood in a tomato sauce.",
	ingredients: [ {
		...
		preparation: IngredientPreparation.Whole,
		measure: {
			amount: MeasureAmountFraction(1, 2),
			unit: MeasureUnit.Cups,
		},
	...
	directions: {
		steps: [
			"Chop the bok choy, separating the stems from the leaves. The leaves will be used later.",
			...
			"Stir in the red pepper flakes, some salt, wine, and tomatoes and cook until the juice starts to come out of the tomatoes, about 3 minutes.",
			"Add wine, water, capers, and olives. Cover and simmer for 5 miniutes.",
			"Season the fish with salt and pepper, then add to the pan nestled within the sauce. Cover and cook until the fish is opaque, about 10 minutes.",
